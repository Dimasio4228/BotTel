...
const token = '1725375570:AAFGrFR0ep4qvTMAkS0WrBqZWTvYJpPDU_g'
...
const start = async () => {
    ...
    bot.on('message', async msg => {
        ...
        try {
            if (text === '/start') {
                let user = await UserModel.findOne({ where: { chatId: `${chatId}` } });
                ...
                return bot.sendMessage(chatId, `Добро пожаловать в телеграм бот Димасика`);
            }
            if (text === '/info') {
